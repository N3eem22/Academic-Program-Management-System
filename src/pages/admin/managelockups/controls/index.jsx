...
import styles from "../controls/index.module.scss";
...
const ControlsPage = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(
        "https://localhost:7095/api/CollegeCourses"
      );
  ...
  const addData = async () => {
    try {
      ...
      setFormData({
        ...formData,
        courseCodeInArabic: toString(formData.courseCodeInArabic),
        sub_CourseCodeInArabic: toString(formData.sub_CourseCodeInArabic),
      });
  ...
  const updateData = async (id) => {
    try {
      ...
      const response = await axios.put(
        `https://localhost:7095/api/CollegeCourses/${id}`,
        formData
      );
                    ...
                    <div className="row">
                      ...
                      <div className="col-xl-6">
                        <div className="form-group mb-3 row">
                          <label
                            className="col-lg-4 col-form-label"
                            htmlFor="sub_CourseNameInEnglish"
                          >
                      ...
                      <div className="col-xl-6">
                        <div className="form-group mb-3 row">
                          <label
                            className="col-lg-4 col-form-label"
                            htmlFor="sub_CourseCodeInArabic"
                          >
                      ...
                      <div className="col-xl-6">
                        <div className="form-group mb-3 row">
                          <label
                            className="col-lg-4 col-form-label"
                            htmlFor="sub_CourseCodeInEnglish"
                          >
                      ...
                      <div className="col-xl-6">
                        <div className="form-group mb-3 row">
                          <label
                            className="col-lg-4 col-form-label"
                            htmlFor="contentSummaryInArabic"
                          >
                      ...
                      <div className="col-xl-6">
                        <div className="form-group mb-3 row">
                          <label
                            className="col-lg-4 col-form-label"
                            htmlFor="contentSummaryInEnglish"
                          >
                      ...
                      <div className="row justify-content-center text-center">
                        <div className="col-md-6">
                          <button
                            className={`btn fs-4 fw-semibold px-4 text-white ${styles.save}`}
                            type="submit"
                          >
