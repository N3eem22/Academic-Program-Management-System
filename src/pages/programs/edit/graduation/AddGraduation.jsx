...
const AddGraduation = ({ data }) => {
  ...
  const validateInputs = () => {
    const errors = {};
    if (!graduation.value) errors.value = "يجب عليك ادخال هذه القيمه";
    if (!graduation.studyYears) errors.studyYears = "يجب عليك ادخال هذه القيمه";
    if (graduation.compulsoryCourses === null) errors.compulsoryCourses = "يجب عليك الاختيار من هذه القيم";
    if (graduation.successInEveryCourse === null) errors.successInEveryCourse = "يجب عليك الاختيار من هذه القيم";
    if (graduation.passingMilitaryEducation === null) errors.passingMilitaryEducation = "يجب عليك الاختيار من هذه القيم";
    if (graduation.summerTraining === null) errors.summerTraining = "يجب عليك الاختيار من هذه القيم";
    if (graduation.determineTheRankBasedOn === null) errors.determineTheRankBasedOn = "يجب عليك الاختيار من هذه القيم";
    if (graduation.rateBase === null) errors.rateBase = "يجب عليك الاختيار من هذه القيم";
    return errors;
  };
  ...
  function submit(e) {
    ...
    if (Object.keys(validationErrors).length > 0) {
      setgraduation((prevState) => ({ ...prevState, validationErrors }));
      return;
    }
    if (globalState.State === "Update") {
      UpdateAPI();
  ...
  function handleClose() {
    dispatch({ type: 'Get' });
    setgraduation((prevState) => ({ ...prevState, err: [], validationErrors: {} })); // Clear errors on close
  }
                ...
                <div className="form-validation">
                  ...
                  >
                    <div className="row">
                      <div className="col-lg-6 ">
                        <div className="form-group d-flex">
                          ...
                          <div className="col-md-2 mx-4 my-3 me-5  pe-3">
                            <input
                              onChange={(e) => {
                                setgraduation({ ...graduation, value: parseInt(e.target.value) });
                                setgraduation(prevState => ({
                                  ...prevState,
                                  validationErrors: { ...prevState.validationErrors, value: '' }
                                }));
                              }}
                              type="number"
                          ...
                          {graduation.validationErrors.value && (
                              <div className="text-danger mt-3 mx-2">
                                {graduation.validationErrors.value}
                              </div>
                            )}
                        </div>
                      ...
                      <div className="form-group  mt-4 d-flex ">
                        ...
                        <div className="col-md-4">
                          <input
                            ...
                            onChange={(e) => {
                              setgraduation({ ...graduation, compulsoryCourses: false });
                              setgraduation((prevState) => ({
                                ...prevState,
                                compulsoryCourses: false,
                                validationErrors: { ...prevState.validationErrors, compulsoryCourses: '' }
                              }));
                            }}
                        ...
                        {graduation.validationErrors.compulsoryCourses && (
                      ...
                      <div className="form-group mt-4 d-flex">
                        <div className="col-md-3">
                          <label className="form-check-label fw-semibold fs-5" htmlFor="passingMilitaryEducation">
                        ...
                        <div className="col-md-6">
                          <input
                            ...
                            onChange={(e) => {
                              setgraduation({ ...graduation, passingMilitaryEducation: true })
                              setgraduation((prevState) => ({
                                ...prevState,
                                passingMilitaryEducation: true,
                                validationErrors: { ...prevState.validationErrors, passingMilitaryEducation: '' }
                              }));
                            }}
                            className="form-check-input ms-3"
                            type="radio"
                          ...
                          />
                          <label className="form-check-label fw-semibold fs-6" htmlFor="passingMilitaryEducation">
                        ...
                        {graduation.validationErrors.passingMilitaryEducation && (
                          <div className="text-danger">
                            {graduation.validationErrors.passingMilitaryEducation}
                          </div>
                        )}
                      ...
                      <div className="form-group mt-4 d-flex">
                        <div className="col-md-3">
                          <label className="form-check-label fw-semibold fs-5" htmlFor="summerTraining">
                            التدريب الصيفي{" "}
                          </label>
                        </div>
                        <div className="col-md-6">
                          <input
                            onChange={(e) => {
                              setgraduation((prevState) => ({
                                ...
                                validationErrors: { ...prevState.validationErrors, summerTraining: '' }
                              }));
                            }}
                            className="form-check-input ms-3"
                            type="radio"
                            name="summerTraining"
                            id="summerTrainingFalse"
                            value={false}
                            checked={graduation.summerTraining === false}
                          />
                          <label className="form-check-label fw-semibold fs-6" htmlFor="summerTrainingFalse">
                          ...
                          <input
                            ...
                            type="radio"
                            name="summerTraining"
                            id="summerTrainingTrue"
                            value={true}
                            checked={graduation.summerTraining === true}
                          />
                          <label className="form-check-label fw-semibold fs-6" htmlFor="summerTrainingTrue">
                            التأكد من إجتياز التدريب الصيفي
                          </label>
                        </div>
                        {graduation.validationErrors.summerTraining && (
                          <div className="text-danger">
                            {graduation.validationErrors.summerTraining}
                          </div>
                        )}
                      ...
                      <div className="form-group  mt-4 d-flex  ">
                        ...
                        <div className="col-md-3">
                          <div className="input-group mb-3 ">
                            <select
                              ...
                              onChange={(e) => {
                                setgraduation({ ...graduation, verifyPaymentOfFees: parseInt(e.target.value) === 0 ? true : false })
                        ...
                        {graduation.validationErrors.verifyPaymentOfFees && (
                          <div className="text-danger">
                            {graduation.validationErrors.verifyPaymentOfFees}
                          </div>
                        )}
                      ...
                      <div className="form-group mt-4 d-flex">
                        <div className="col-md-3 fw-semibold fs-5">
                          <label className="col-form-label" htmlFor="determineTheRankBasedOn">
                        ...
                        <div className="col-md-4">
                          <input
                            ...
                            onChange={(e) => {
                              setgraduation((prevState) => ({
                                ...prevState,
                                determineTheRankBasedOn: parseInt(e.target.value),
                                validationErrors: { ...prevState.validationErrors, determineTheRankBasedOn: '' }
                              }));
                            }}
                            checked={graduation.determineTheRankBasedOn === 0}
                          />
                          <label className="form-check-label fw-semibold fs-6" htmlFor="determineTheRankBasedOn">
                            المعدل{" "}
                          </label>
                          ...
                          <input
                            ...
                            type="radio"
                            name="determineTheRankBasedOn"
                            id="determineTheRankBasedOnPercentage"
                            value={1}
                            onChange={(e) => {
                              setgraduation((prevState) => ({
                                ...prevState,
                          ...
                          />
                          <label className="form-check-label fw-semibold fs-6" htmlFor="determineTheRankBasedOnPercentage">
                            النسبة{" "}
                          </label>
                        </div>
                        {graduation.validationErrors.determineTheRankBasedOn && (
                          <div className="text-danger">
                            {graduation.validationErrors.determineTheRankBasedOn}
                          </div>
                        )}
                        ...
                        <div className="col-md-4">
                          <input
                            ...
                            onChange={(e) => {
                              setgraduation((prevState) => ({
                                ...prevState,
                                rateBase: parseInt(e.target.value),
                                validationErrors: { ...prevState.validationErrors, rateBase: '' }
                              }));
                            }}
                            checked={graduation.rateBase === 0}
                          />
                          <label className="form-check-label fw-semibold fs-6" htmlFor="rateBase">
                            الفصلي
                          </label>
                          ...
                          />
                          <label className="form-check-label fw-semibold fs-6" htmlFor="rateBaseCumulative">
                            التراكمي
                          </label>
                        </div>
                        {graduation.validationErrors.rateBase && (
                          <div className="text-danger">
                            {graduation.validationErrors.rateBase}
                          </div>
                        )}
                      ...
                      <div className="col-lg-6 ">
                        <div className="form-group d-flex mt-2">
                          ...
                          <div className="col-md-2  my-2 ">
                            <input
                              onChange={(e) => {
                                setgraduation({ ...graduation, studyYears: parseInt(e.target.value) })
                                setgraduation(prevState => ({
                                  ...prevState,
                                  validationErrors: { ...prevState.validationErrors, studyYears: '' }
                                }));
                              }}
                          ...
                          {graduation.validationErrors.studyYears && (
                            <div className="text-danger mt-2 mx-2">
                              {graduation.validationErrors.studyYears}
                            </div>
                          )}
                        </div>
